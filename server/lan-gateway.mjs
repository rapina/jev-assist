...
const DASHBOARD_GET = new Set(['/dashboard', '/dashboard/', '/dashboard/dashboard.js', '/dashboard/dashboard.css', '/dashboard/skill.md', '/dashboard/install-client.ps1', '/dashboard/client.zip',
