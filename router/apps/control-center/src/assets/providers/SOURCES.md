...
| `stealth.svg` | Codenamed preview models with no maker's mark of their own (Ox Alpha, Union Alpha, Omen Alpha, Fugu Ultra, Inkling), and the user-defined Custom provider | n/a | Original artwork drawn for this repository; not a third-party mark |
